import { cartItemInterface, productDetails } from './../../shared/store/interfaces/cart-item.model';
...
export class CartService {
  ...
  dashboard: productDetails[] = [
    ...
    { 
      basic: { productName: 'Slim Fit Flat-Front Trousers',
      productID: 'BBBBB',
      productCount: 2,
      productPrice: 20,
      isFavorite: false
    ...
    { 
      basic: { productName: 'Printed Hooded Sweatshirt',
      productID: 'CCCCC',
      productCount: 2,
      productPrice: 180,
      isFavorite: false
  ...
  getCartProducts(): Observable<cartItemInterface[]>  {
    const cartIntervalObservable = new Observable<cartItemInterface[]>(observer => {
  ...
  getFavorites(): Observable<cartItemInterface[]>  {
    const favIntervalObservable = new Observable<cartItemInterface[]>(observer => {
